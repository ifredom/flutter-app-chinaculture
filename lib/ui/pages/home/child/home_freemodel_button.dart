...
class HomeFreeModelButton extends StatelessWidget {
  @override
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            fit: BoxFit.cover,
            image: AssetImage("assets/images/index/model-btn.png"),
          ),
        ),
      ),
      onTap: () {
        locator<NavigationService>().push(RoutesUtils.freemodePage);
      },
    );
  }
}
